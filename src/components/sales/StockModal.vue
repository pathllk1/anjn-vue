...
<template>
  <div class="flex flex-col h-full">
    <!-- Inline Search/Actions bar (not a header) -->
    <div class="flex items-center gap-2 p-3 bg-(--ui-bg-muted) border-b border-(--ui-border)">
      <UInput v-model="searchTerm" autofocus placeholder="Search items…"
